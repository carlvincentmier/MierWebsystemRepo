...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if (isset($_POST['delete_product'])) {
    ...
    if ($stmt->execute([$id])) {
      ...
      $addMsg = '<div class="alert alert-danger mb-2">Error deleting product.</div>';
    }
  }
}
...
<body>
    ...
    <div class="container nav">
      ...
      <div class="nav-actions">
        ...
        <!-- Add this button for admin profile -->
  ...
  <!-- Items to Sell Tab (unchanged, working) -->
  <div class="tab-pane fade show active" id="items" role="tabpanel">
    <!-- ... your existing Items to Sell code ... -->
    <!-- (copy from your file, do not change this tab!) -->
...
<!-- Replace only the Order Summary tab content below, keeping all other code as is! -->
